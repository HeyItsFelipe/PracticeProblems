...
const numberOfLines = (widths, S) => {
  ...
  for (let i = 0; i < S.length; i++) {
    ...
    let unitToAdd = widths[index];
    if (currentLineTotal + unitToAdd > 100) {
      currentLineTotal = unitToAdd;
      ++linesTotal;
    } else {
      currentLineTotal += unitToAdd;
    }
  ...
  ++linesTotal;
  return [linesTotal, currentLineTotal];
};
...
/*
The string is iterated through once.
